    ...
    <div className="w-full h-screen flex flex-col bg-slate-950 text-white">
      ...
      {selectedDevice && (
        <div className="absolute top-[96px] right-0 w-80 h-[calc(100%-96px)] bg-slate-950/98 shadow-2xl z-30 p-4 overflow-y-auto border-l border-slate-800">
          {/* ... panneau latéral identique à ta version précédente ... */}
          {/* (je ne réécris pas ici pour ne pas exploser la taille, mais garde exactement le contenu
              de ton panneau Timeline & Télécommande qui fonctionnait – il ne dépend pas des types
              d’icônes.) */}
        </div>
      )}
